...
const LatestTicketCard = ({ ticket }) => {
  ...
  return (
  <div className="group overflow-hidden rounded-3xl border border-cyan-500/10 bg-white shadow-sm transition-all duration-300 hover:-translate-y-2 hover:border-cyan-500/40 hover:shadow-lg dark:bg-[#111827]">
  ...
  <div className="relative h-60 overflow-hidden">
    ...
    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent dark:from-[#111827] dark:via-[#111827]/30" />
    ...
    <div className="absolute bottom-5 left-5 right-5 flex items-center justify-between">
      ...
      <div className="mx-3 h-px flex-1 border-t border-dashed border-gray-300/70" />
  ...
  <div className="space-y-5 p-5">
    ...
    <div>
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="mt-2 rounded-full border border-yellow-500/30 bg-yellow-500/10 px-3 py-1 text-xs font-semibold text-yellow-600 dark:bg-yellow-500/20 dark:text-yellow-400">
    ...
    <div className="flex flex-wrap gap-2">
      {ticket.perks.slice(0, 3).map((perk) => (
        <span
          key={perk}
          className="rounded-full bg-cyan-500/10 px-3 py-1 text-xs text-cyan-600 dark:text-cyan-300"
        >
          {perk}
        </span>
      ))}
    ...
    <div className="flex items-center justify-between">
      ...
      <div>
        <p className="text-xs uppercase text-slate-500 dark:text-gray-500">
          Price
        </p>
