...
const AdvertisementCard = ({ ticket }) => {
  ...
  return (
    <div className="group overflow-hidden rounded-3xl border border-cyan-500/10 bg-white shadow-sm transition duration-300 hover:-translate-y-2 hover:border-cyan-500/40 hover:shadow-lg dark:bg-[#091425]">
  ...
  <div className="space-y-5 p-6">
    ...
    <div>
      ...
      <p className="mt-2 font-semibold text-slate-600 dark:text-gray-400">
    ...
    <div className="flex items-center justify-between rounded-xl bg-slate-50 p-4 dark:bg-[#0D1B2A]">
