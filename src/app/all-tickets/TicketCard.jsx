...
const TicketCard = ({ ticket }) => {
  return (
   <div className="overflow-hidden rounded-3xl border border-cyan-500/20 bg-white shadow-sm dark:bg-[#091425] dark:shadow-none">
  <img
    src={ticket.image}
    alt={ticket.title}
  ...
  <div className="p-5">
    ...
    <p className="mb-2 text-slate-600 dark:text-gray-400">
      {ticket.from} → {ticket.to}
    </p>

    <p className="mb-4 text-cyan-600 dark:text-cyan-400">
